        ...
        <div className='p-10 bg-[#f2f2f2]'>
            ...
            <form className=' mt-4 '>
                <div className="relative">
                    ...
                    <input onChange={(e) => setSearch(e.target.value)} type="search" className="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg shadow-inner-md bg-gray-200 " placeholder="Search Here" />
                </div>
            </form>
